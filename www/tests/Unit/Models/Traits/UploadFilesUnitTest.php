...
class UploadFilesUnitTest extends TestCase
{
    ...
    {
        Storage::fake();
        $file1 = UploadedFile::fake()->create('video11.mp4');
        $file2 = UploadedFile::fake()->create('video22.mp4');
    ...
    {
        Storage::fake();
        $file1 = UploadedFile::fake()->create('video111.mp4');
        $file2 = UploadedFile::fake()->create('video222.mp4');
        $this->obj->uploadFiles([$file1, $file2]);
    ...
    public function testDeleteFile()
    {
        ...
        $file = UploadedFile::fake()->create('newvideo.mp4');
        $this->obj->uploadFile($file);
